...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      check_subscription_expiry: { Args: Record<PropertyKey, never>; Returns: number }
      ...
      expire_listing_boosts: { Args: Record<PropertyKey, never>; Returns: undefined }
      generate_product_slug: {
        Args: { product_id: string; title: string }
        Returns: string
      }
      generate_share_token: { Args: Record<PropertyKey, never>; Returns: string }
      ...
      get_total_unread_messages: { Args: Record<PropertyKey, never>; Returns: number }
