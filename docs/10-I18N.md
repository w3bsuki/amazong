# 10-I18N.md — Internationalization Reference
...
formatPrice(2999, 'en')                    // Expects cents
formatPriceRange(1000, 2000, 'bg')         // "10,00 € – 20,00 €"
formatDiscount(20)                         // "-20%"
```
...
- [05-ROUTES.md](./05-ROUTES.md) — Route structure with `[locale]`
