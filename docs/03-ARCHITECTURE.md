...
- [01-PRD.md](./01-PRD.md) — Product vision & scope
- [02-FEATURES.md](./02-FEATURES.md) — Feature checklist
- [04-DESIGN.md](./04-DESIGN.md) — UI/UX rules
- [05-ROUTES.md](./05-ROUTES.md) — Route map
