...
**Action:** Notifications INSERT policy is currently too broad in production migrations due to `authenticated` table privileges. Draft hardening migration exists; follow `docs/RISK.md` stop-and-ask policy before applying.
