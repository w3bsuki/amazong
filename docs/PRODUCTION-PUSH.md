# PRODUCTION-PUSH.md — Treido V1 Ship Plan
...
| Playwright audit | `.codex/audit/playwright/2026-02-02/INDEX.md` |
...
| Launch checklist / ops | `LAUNCH.md` |
...
| Metric | Value |
|---|---|
| Feature completion | ~87% documented (`FEATURES.md`), ~92% actual (see feature alignment audit) |
...
Goal: update `FEATURES.md` to match reality (docs are conservative).
...
Deploy:
- Follow `LAUNCH.md` (Vercel + Supabase + Stripe checklist).
...
- `FEATURES.md` reflects actual shipped V1 scope.
