...
> SSOT moved to `AGENTS.md` + `docs/*`. This file is kept for historical context and will be archived once the team stops using it.
...
2. Check docs/FEATURES.md  → What's built (✅) vs pending (⬜)?
...
| Doc | Purpose |
|-----|---------|
| `AGENTS.md` | Agent entry point + rails |
...
| Doc | Purpose |
|-----|---------|
| `docs/ARCHITECTURE.md` | Stack, boundaries, caching, backend |
| `docs/DESIGN.md` | UI tokens, patterns |
...
- If task changes scope, update `docs/FEATURES.md` in the same batch
