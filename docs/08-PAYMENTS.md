# 08-PAYMENTS.md — Stripe Payments & Connect
...
| Doc | Relevance |
|-----|-----------|
| [06-DATABASE.md](./06-DATABASE.md) | Full schema + RLS policies |
| [07-API.md](./07-API.md) | Server actions reference |
| [03-ARCHITECTURE.md](./03-ARCHITECTURE.md) | System overview |
