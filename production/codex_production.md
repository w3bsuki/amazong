# Codex — Production — V1 Launch Alignment (Treido)
...
- `pnpm -s dupes` ⚠️ (316 clone groups, ~3.4% duplicated lines)
...
- Canonical product scope: `docs/PRD.md`, `docs/FEATURES.md`
- Canonical engineering rules: `AGENTS.md`, `docs/ARCHITECTURE.md`, `docs/DESIGN.md`
- Working backlog: `TASKS.md` + `ISSUES.md`
- Supabase deep dives (reference): `supabase-codex/`
