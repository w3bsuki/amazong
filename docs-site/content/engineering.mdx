...
- [REQUIREMENTS.md](/project) — Feature requirements checklist
- [docs/ui/DESIGN.md](/design) — UI/UX rules
- [docs/domain/ROUTES.md](/routes) — Route map
- [AGENTS.md](/workflow) — Entry point + non-negotiables
- [docs/WORKFLOW.md](/workflow) — Default shipping loop
