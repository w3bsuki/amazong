...
- [PAYMENTS.md](/payments) — Stripe Connect, escrow lifecycle, webhook processing, payout release rules
- [plans.md](./plans.md) — Subscription tier details, pricing, listing limits
- [DATABASE.md](/database) — subscription_plans, subscriptions, listing_boosts tables
- [PRD.md](/platform) §5.1–5.6 — Business model, fee formulas, unit economics
