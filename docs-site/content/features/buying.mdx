...
- [PAYMENTS.md](/payments) — Stripe payment intents, Buyer Protection fee formula, webhook processing
- [DATABASE.md](/database) — Orders schema, cart_items, wishlists
- [ROUTES.md](/routes) — (main), (checkout), (account), [username] route groups
- [API.md](/api) — Checkout and payment endpoints
