...
- [PAYMENTS.md](/payments) — Escrow lifecycle, payout blocking during disputes, refund processing
- [DATABASE.md](/database) — reviews, badge_definitions, user_badges, seller_stats tables
- [chat.md](./chat.md) — Report conversation, block user flows
- [buying.md](./buying.md) — Buyer protection claims, order disputes
- [PRD.md](/platform) §6.9 (Reviews), §6.10 (Trust & Safety), §12 (Operations)
