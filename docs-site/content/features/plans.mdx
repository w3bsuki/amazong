...
- [PAYMENTS.md](/payments) — Stripe subscription integration, billing portal
- [DATABASE.md](/database) — subscription_plans, subscriptions tables
- [ROUTES.md](/routes) — (plans) and (account) route groups
