...
This creates `docs/generated/db-schema.md` (`docs/generated/db-schema.md`) from `supabase/migrations/**`.
...
- Pre-cutover full reference: `docs/archive/2026-02-doc-reset/pre-cutover-docs/DATABASE.md` (`docs/archive/2026-02-doc-reset/pre-cutover-docs/DATABASE.md`)
