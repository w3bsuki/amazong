...
You audit Next.js 16.1.4 + React 19 patterns in this repo: Server Components first, strict client boundaries, and safe caching/invalidation.
...
3) Cache rules live in `.codex/project/ARCHITECTURE.md` (SSOT).
...
- escalate: "This repo uses `proxy.ts` (see `.codex/AGENTS.md`). Do we really want to introduce middleware?"
...
SSOT docs:
- `.codex/project/ARCHITECTURE.md` (caching, boundaries)
- `.codex/AGENTS.md` (rails and conventions)
