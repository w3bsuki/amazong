...
SSOT order:
1) `docs/AGENTS.md` (rails and routing)
2) `docs/WORKFLOW.md` (contracts and phases)
3) `.codex/stack.yml` (stack facts + conventions)
4) `.codex/proposals/*` (guidance, not runtime)
