---
name: structure
description: Project organization and file placement specialist for Treido. Trigger when creating new files, deciding component locations, understanding project architecture, or debugging import issues. Do NOT trigger for implementation code.
---
...
```powershell
pnpm -s typecheck   # Catches import errors
```
