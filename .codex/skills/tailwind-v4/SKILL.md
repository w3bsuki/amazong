---
name: tailwind-v4
description: Tailwind CSS v4 expertise for Treido. Trigger when styling components, reviewing Tailwind classes, or working on globals.css. NOT for component logic or data.
---
...
```powershell
pnpm -s styles:gate    # Catches all violations
pnpm -s lint           # Additional checks
```
