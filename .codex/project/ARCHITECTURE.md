# Architecture — Technical Reference (SSOT)
...
## UI Ownership Map (where to edit)

- App header (all variants): `components/layout/header/app-header.tsx`
  - Mobile variants: `components/layout/header/mobile/*`
  - Desktop variants: `components/layout/header/desktop/*`
...
- Quick view:
  - Shared content: `components/shared/product/quick-view/*`
  - Desktop wrapper: `components/desktop/product/product-quick-view-dialog.tsx`
  - Mobile wrapper: `components/mobile/drawers/product-quick-view-drawer.tsx`
- Cart UI:
...
- **Verification**: typecheck + e2e:smoke minimum (see `AGENTS.md`)
...
| [FEATURES.md](FEATURES.md) | Feature checklist + route map |
