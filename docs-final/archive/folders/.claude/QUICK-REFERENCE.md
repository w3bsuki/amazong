...
| `frontend-ui` | UI changes | Premium UI/UX without AI slop |
...
|--------|-------|---------|
| `COORD:` | treido-coordinator | Pick the next spec/task |
| `SPEC:` | treido-spec | Create/update `.specs` work packs |
| `TREIDO:` | treido-dev | Execute the next task (spec or TODO) |
| `FRONTEND:` | treido-frontend | UI/components/styling/i18n |
| `BACKEND:` | treido-backend | Route handlers/actions/webhooks |
| `REFACTOR:` | treido-refactor | Safe incremental refactors |
| `AUDIT:` | treido-audit | Cross-lane audits/reviews |
| `TEST:` | treido-testing | Unit/E2E work and flakes |
...
- **PreToolUse**: Blocks secrets access and unsafe paths
...
1. `COORD: pick the next spec/task` (or `TREIDO: Work on .specs/active/<spec>`)
