...
Related:
- UI tokens + styling rails: `DESIGN.md`
- Boundaries, caching, and backend rules: `ENGINEERING.md`
...
- Don’t introduce gradients or arbitrary Tailwind values (see `DESIGN.md`).
