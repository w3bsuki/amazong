...
Related:
- Boundaries + caching rules: `docs/ENGINEERING.md`
- Production checklist (env/webhooks/advisors): `docs/PRODUCTION.md`
...
Production checklist for Stripe (env vars, endpoints, go-live): see `docs/PRODUCTION.md`.
