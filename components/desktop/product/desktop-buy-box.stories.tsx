/**
 * DesktopBuyBox Stories - Sticky buy box with embedded seller
 *
 * This is real production UI. Styling changes here = styling changes in main app.
 */
import type { Meta, StoryObj } from "@storybook/nextjs-vite"
import { DesktopBuyBox } from "./desktop-buy-box"

const meta: Meta<typeof DesktopBuyBox> = {
  title: "Commerce/DesktopBuyBox",
  component: DesktopBuyBox,
  parameters: {
    layout: "centered",
  },
  tags: ["autodocs"],
