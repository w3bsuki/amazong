...
const MOBILE_PRIMARY_TAB_BASE_CLASS =
  "relative inline-flex min-h-(--control-default) items-center gap-1.5 px-3 text-sm leading-none tap-transparent motion-safe:transition-colors motion-safe:duration-fast motion-safe:ease-(--ease-smooth) motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-inset"
...
const MOBILE_PRIMARY_TAB_INACTIVE_CLASS = "font-medium text-muted-foreground hover:text-foreground"

const MOBILE_QUICK_PILL_BASE_CLASS =
  "inline-flex shrink-0 items-center whitespace-nowrap rounded-full border min-h-(--control-compact) px-3 text-xs leading-none tap-transparent motion-safe:transition-colors motion-safe:duration-fast motion-safe:ease-(--ease-smooth) motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-1"
const MOBILE_QUICK_PILL_ACTIVE_CLASS = "border-foreground bg-foreground text-background font-semibold shadow-sm"
const MOBILE_QUICK_PILL_INACTIVE_CLASS = "border-border-subtle bg-surface-subtle text-muted-foreground font-medium hover:border-border hover:text-foreground"

export const MOBILE_ACTION_CHIP_CLASS =
  "inline-flex shrink-0 min-h-(--control-compact) items-center gap-1.5 rounded-full border border-border-subtle bg-surface-subtle px-3 text-xs font-semibold leading-none text-foreground tap-transparent motion-safe:transition-colors motion-safe:duration-fast motion-safe:ease-(--ease-smooth) motion-reduce:transition-none hover:bg-hover hover:border-border active:bg-active focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-1"
