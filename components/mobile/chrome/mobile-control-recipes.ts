...
const MOBILE_PRIMARY_TAB_BASE_CLASS =
  "relative inline-flex min-h-(--control-compact) items-center gap-1.5 rounded-full px-3.5 text-[13px] leading-none tap-transparent motion-safe:transition-all motion-safe:duration-fast motion-safe:ease-(--ease-smooth) motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-inset"
...
const MOBILE_QUICK_PILL_BASE_CLASS =
  "inline-flex shrink-0 items-center whitespace-nowrap rounded-full border border-transparent min-h-(--control-compact) px-3.5 text-[13px] leading-none tap-transparent motion-safe:transition-all motion-safe:duration-fast motion-safe:ease-(--ease-smooth) motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring flex-1 justify-center sm:flex-none"
