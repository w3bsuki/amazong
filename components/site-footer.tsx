    ...
    return (
        ...
        >
                                    ...
                                    <ul className="flex flex-col gap-3 pb-2">
                                        {section.links.map((link, linkIndex) => (
                                            <li key={linkIndex}>
                                                <Link 
                                                    href={link.href} 
                                                    className="text-sm text-primary-foreground/60 hover:text-primary-foreground transition-colors tap-transparent py-1 inline-block"
                                                >
                                                    {link.label}
                                                </Link>
                                            </li>
                                    ...
                                    <ul className="space-y-2.5">
                                        {section.links.map((link, linkIndex) => (
                                            <li key={linkIndex}>
                                                <Link 
                                                    href={link.href} 
                                                    className="text-sm text-primary-foreground/60 hover:text-primary-foreground hover:underline underline-offset-2 transition-colors inline-block"
                                                >
                                                    {link.label}
                                                </Link>
                                            </li>
            ...
            <div className="max-w-7xl mx-auto px-4 py-10">
                ...
                {/* Legal Links */}
                <nav aria-label={t('legalLinks')} className="flex flex-wrap justify-center gap-x-5 gap-y-2.5 text-xs text-primary-foreground/50 mb-6">
