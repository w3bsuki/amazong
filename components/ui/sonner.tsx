...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      // Custom icons
      icons={{
        success: <CheckCircle className="size-5 text-brand-success" weight="fill" />,
        error: <XCircle className="size-5 text-destructive" weight="fill" />,
        warning: <WarningCircle className="size-5 text-brand-warning" weight="fill" />,
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton: 'group-[.toast]:bg-brand group-[.toast]:text-foreground group-[.toast]:font-medium group-[.toast]:text-sm',
          cancelButton: 'group-[.toast]:bg-muted group-[.toast]:text-muted-foreground group-[.toast]:font-medium group-[.toast]:text-sm',
          closeButton: 'group-[.toast]:bg-transparent group-[.toast]:text-muted-foreground group-[.toast]:hover:text-foreground group-[.toast]:border-none',
          success: 'group-[.toaster]:border-brand-success/30 group-[.toaster]:bg-brand-success/10',
          error: 'group-[.toaster]:border-destructive/30 group-[.toaster]:bg-destructive/10',
          warning: 'group-[.toaster]:border-brand-warning/30 group-[.toaster]:bg-brand-warning/10',
