      ...
      <div className="mx-auto w-full max-w-[88.125rem]">
        <div className="relative grid grid-cols-1 gap-7 gap-7.5 lg:grid-cols-5 xl:gap-18">
          ...
          <div className="lg:col-span-2">
            {/* Non-sticky right column like eBay/Amazon for better desktop UX */}
            <div className="flex flex-col gap-6">
              <h1 className="text-2xl leading-tight font-semibold tracking-tight xl:text-3xl">
              ...
              <p className="text-foreground/80 leading-relaxed">{PRODUCT_DETAILS.description}</p>
              <ProductForm
              ...
              />
              {/* Shipping highlights with semantic colors */}
