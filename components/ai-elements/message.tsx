        ...
        <>
          ...
          {onRemove && (
            <Button
              ...
              className="absolute top-1.5 right-1.5 size-6 rounded-full bg-destructive/80 p-0 text-destructive-foreground opacity-0 transition-opacity hover:bg-destructive group-hover:opacity-100 [&>svg]:size-3"
              onClick={(e) => {
                e.stopPropagation();
                onRemove();
              }}
