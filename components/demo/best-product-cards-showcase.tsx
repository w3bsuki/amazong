...
const recipes: CardRecipe[] = [
  {
    id: "everyday-grid",
    title: "Everyday Grid",
    description: "Fast scan: image, title, price, wishlist + menu.",
    card: {
      id: "demo-1",
  ...
  },
  {
    id: "clean-compact",
    title: "Clean Compact",
    description: "Compact layout for dense grids and category pages.",
    card: {
      id: "demo-4",
  ...
  },
  {
    id: "meta-tags",
    title: "Meta + Tags",
    description: "One meta line + tag chips (best for browse + trust).",
    card: {
      id: "demo-5",
  ...
  },
  {
    id: "featured-hero",
    title: "Featured Hero",
    description: "Featured layout with hover quick-add (desktop).",
    card: {
      id: "demo-7",
  ...
  },
  {
    ...
    description: "Data-first card: specs as tags + clear unit price.",
    card: {
      id: "demo-8",
  ...
  },
  {
    id: "c2c-minimal",
    title: "C2C Minimal",
    description: "C2C-friendly: compact, minimal metadata, no cart.",
    card: {
      id: "demo-9",
  ...
  },
  {
    ...
    description: "Premium feel: seller trust + tags, no hover-only CTAs.",
    card: {
      id: "demo-10",
...
export function BestProductCardsShowcase({
  ...
  subheading = "Clean, production-ready configurations built on our existing ProductCard.",
}: {
  heading?: string
  subheading?: string
}) {
