...
export function PromoCard({ 
  ...
  return (
    ...
    >
      ...
      {/* Badge */}
      {badge && (
        <span className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-badge-deal text-white text-[10px] sm:text-xs font-bold px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full">
          {badge}
        </span>
      )}
