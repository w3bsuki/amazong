      ...
      <div className="w-full max-w-screen-2xl relative z-10 mb-6 px-0 sm:px-3 -mt-6 sm:-mt-28 md:-mt-32">
          ...
          <div className="bg-card rounded-lg border border-border p-2.5 sm:p-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Link href="/search?category=laptops" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Лаптопи" : "Laptops"}</span>
              </Link>
              <Link href="/search?category=desktops" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Настолни" : "Desktops"}</span>
              </Link>
              <Link href="/search?category=monitors" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Монитори" : "Monitors"}</span>
              </Link>
              <Link href="/search?category=accessories" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Аксесоари" : "Accessories"}</span>
              </Link>
            </div>
          ...
          <div className="bg-card rounded-lg border border-border p-2.5 sm:p-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Link href="/search?category=kitchen" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Кухня" : "Kitchen"}</span>
              </Link>
              <Link href="/search?category=furniture" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Мебели" : "Furniture"}</span>
              </Link>
              <Link href="/search?category=bedding" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Спално бельо" : "Bedding"}</span>
              </Link>
              <Link href="/search?category=decor" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Декорация" : "Decor"}</span>
              </Link>
            </div>
          ...
          <div className="bg-card rounded-lg border border-border p-2.5 sm:p-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Link href="/search?category=women" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Дамски" : "Women"}</span>
              </Link>
              <Link href="/search?category=men" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Мъжки" : "Men"}</span>
              </Link>
              <Link href="/search?category=shoes" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Обувки" : "Shoes"}</span>
              </Link>
              <Link href="/search?category=bags" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Чанти" : "Bags"}</span>
              </Link>
            </div>
          ...
          <div className="bg-card rounded-lg border border-border p-2.5 sm:p-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Link href="/search?category=skincare" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Грижа" : "Skincare"}</span>
              </Link>
              <Link href="/search?category=makeup" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Грим" : "Makeup"}</span>
              </Link>
              <Link href="/search?category=haircare" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Коса" : "Haircare"}</span>
              </Link>
              <Link href="/search?category=fragrance" className="group touch-action-manipulation active:scale-95 transition-transform">
                ...
                <span className="text-[11px] sm:text-xs text-foreground group-hover:text-brand-blue block mt-1.5 font-medium">{locale === "bg" ? "Парфюми" : "Fragrance"}</span>
              </Link>
            </div>
              ...
              {[
                ...
                >
                  <div className={cn(
                    ...
                    "border-2 border-border group-hover:border-brand-blue transition-all duration-200",
                  ...
                  {!cat.highlight && (
                    <span className="text-[10px] sm:text-xs text-foreground group-hover:text-brand-blue font-medium text-center transition-colors line-clamp-1">
                      {cat.name}
                    </span>
                  )}
                </Link>
        ...
        <div className="mt-4 sm:mt-6 px-3 sm:px-0">
          ...
          ">
            ...
            <Link 
              href="/search?category=fashion" 
              className="group relative w-[42vw] min-w-[42vw] h-44 shrink-0 snap-start rounded-lg overflow-hidden bg-zinc-900 sm:w-auto sm:min-w-0 sm:h-auto sm:min-h-60"
            >
              <img 
        ...
        {!user && (
          <div className="mt-4 sm:mt-6 px-3 sm:px-0">
            <div className="bg-linear-to-r from-blue-600 to-blue-700 rounded-lg p-4 sm:p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <Link href="/auth/login">
                <Button className="min-h-12 px-8 bg-white hover:bg-muted text-blue-700 text-sm font-semibold rounded-full touch-action-manipulation active:scale-95 transition-transform">
