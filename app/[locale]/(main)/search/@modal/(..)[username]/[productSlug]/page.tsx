...
export default async function ProductQuickViewModalPage({
  ...
  return (
    <ProductRouteModal title={productData.title}>
        ...
        <div className="min-w-0 space-y-4">
          <div className="space-y-2">
            ...
            {productData.condition && (
              <span className="inline-flex h-touch-sm items-center rounded-full bg-success/10 px-3 text-xs font-medium text-success">
                {productData.condition}
              </span>
            )}
          </div>
