...
import { WarningCircle, ArrowCounterClockwise, Users } from '@phosphor-icons/react'
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-foreground mb-2">Members unavailable</h1>

        <p className="text-muted-foreground mb-6">
          We couldn&apos;t load the community members list. Please try again.
        </p>
