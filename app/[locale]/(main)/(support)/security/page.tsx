  ...
  return (
    <div className="min-h-screen bg-background pb-20 sm:pb-12">
      ...
      <div className="container py-8 md:py-12">
        ...
        <Card className="mb-8 border-brand/20 bg-gradient-to-r from-brand/5 to-transparent">
          <CardContent className="p-6 md:p-8">
            <div className="flex flex-col md:flex-row md:items-center gap-6">
              <div className="flex items-center gap-4">
                <div className="size-16 bg-[#635bff]/10 rounded-xl flex items-center justify-center shrink-0">
              ...
              <Card key={index} className="hover:shadow-md transition-shadow">
                <CardContent className="p-5">
                  <div className="flex items-start gap-4">
                    <div className="size-12 bg-brand/10 rounded-lg flex items-center justify-center shrink-0">
                      <feature.icon className="size-6 text-brand" weight="duotone" />
                    </div>
                    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {accountFeatures.map((feature, index) => (
              <Card key={index} className="hover:shadow-md transition-shadow">
                <CardContent className="p-5">
                  <div className="flex items-start gap-4">
                    <div className="size-12 bg-emerald-500/10 rounded-lg flex items-center justify-center shrink-0">
                      <feature.icon className="size-6 text-emerald-600" weight="duotone" />
                    </div>
                    <div>
                      <h3 className="font-semibold mb-1">{feature.title}</h3>
                      <p className="text-sm text-muted-foreground">{feature.desc}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {fraudProtection.map((feature, index) => (
              <Card key={index} className="hover:shadow-md transition-shadow">
                <CardContent className="p-5">
                  <div className="flex items-start gap-4">
                    <div className="size-12 bg-amber-500/10 rounded-lg flex items-center justify-center shrink-0">
                      <feature.icon className="size-6 text-amber-600" weight="duotone" />
                    </div>
                    <div>
                      <h3 className="font-semibold mb-1">{feature.title}</h3>
                      <p className="text-sm text-muted-foreground">{feature.desc}</p>
          ...
          <CardContent className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <CheckCircle className="size-5 text-green-600 shrink-0 mt-0.5" weight="fill" />
        ...
        <Card className="border-brand/20">
          <CardContent className="p-6 md:p-8">
            <div className="flex flex-col md:flex-row md:items-center gap-6">
              <div className="flex items-center gap-4">
                <div className="size-14 bg-brand/10 rounded-full flex items-center justify-center shrink-0">
                  <ShieldCheck className="size-7 text-brand" weight="fill" />
                </div>
                <div>
              ...
              <div className="md:ml-auto flex flex-col sm:flex-row gap-3">
                ...
                <a href="mailto:security@treido.eu">
                  <Button className="w-full sm:w-auto bg-brand hover:bg-brand-dark">
