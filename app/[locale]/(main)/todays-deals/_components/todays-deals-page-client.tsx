...
type TodaysDealsPageClientProps = {
    locale: string
    tabLabels: TodaysDealsTabLabels
}
...
const dealCategories: { id: string; icon: Icon }[] = [
    { id: "all", icon: Fire },
    { id: "electronics", icon: DeviceMobile },
    { id: "home", icon: House },
    { id: "fashion", icon: TShirt },
    { id: "beauty", icon: PaintBrush },
    { id: "toys", icon: PuzzlePiece },
    { id: "sports", icon: Barbell },
]
...
const deals: Deal[] = [
    ...
    },
    {
        ...
        image:
            "https://images.unsplash.com/photo-1543512214-318c77a07298?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
        discount: 35,
        price: 39.99,
        originalPrice: 59.99,
        rating: 4.6,
    ...
    },
    {
        ...
        image:
            "https://images.unsplash.com/photo-1588854337221-4cf9fa96059c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
        discount: 40,
        price: 59.95,
        originalPrice: 99.99,
        rating: 4.7,
...
export default function TodaysDealsPageClient({
    locale,
    tabLabels,
}: TodaysDealsPageClientProps) {
    ...
    const tabs = [
        ...
        { id: "upcoming", label: tabLabels.upcoming },
        { id: "watchlist", label: tabLabels.watchlist },
    ]
    ...
    // activeTab is currently UI-only (kept for parity with existing UX)
    void activeTab
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-1 text-brand-deal text-xs font-medium mb-2">
                                ...
                                <span>
                                    {locale === "bg" ? "Приключва след" : "Ends in"} {deal.timeLeft}
                                </span>
                            </div>
