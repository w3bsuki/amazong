...
import { WarningCircle, ArrowCounterClockwise, Storefront } from '@phosphor-icons/react'
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-foreground mb-2">Dashboard unavailable</h1>

        <p className="text-muted-foreground mb-6">
          We couldn&apos;t load the seller dashboard right now. Please try again.
        </p>
