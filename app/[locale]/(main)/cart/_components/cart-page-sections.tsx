...
export function CartItemsList({
  ...
  getProductUrl: (item: CartItemShape) => string
  t: Translate
  tCartDropdown: Translate
}) {
  return (
          ...
          <CardContent className="p-5">
            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-success font-medium">{t("freeLabel")}</span>
              </div>
            </div>
...
export function CartMobileFooter({
  subtotal,
  formatPrice,
  handleCheckout,
  t,
