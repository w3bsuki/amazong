...
// Loading overlay for sign-up process
function SignUpLoadingOverlay({ isVisible }: { isVisible: boolean }) {
      ...
      <div className="flex min-h-svh w-full items-center justify-center p-6 md:p-10 bg-background">
        <div className="w-full max-w-[350px]">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        className={cn(
                          "h-8 rounded-sm border-input focus-visible:ring-1 focus-visible:ring-brand focus-visible:border-brand",
                          repeatPassword && password !== repeatPassword && "border-destructive focus-visible:ring-destructive"
                        )}
                      />
                    ...
                    <Button
                      ...
                      disabled={isLoading || (repeatPassword !== '' && password !== repeatPassword)}
                    >
          ...
          <div className="mt-8 text-center space-y-2">
            ...
            <p className="text-xs text-muted-foreground">© 1996-{new Date().getFullYear()}, Amazon.com, Inc. or its affiliates</p>
          </div>
        </div>
      </div>
    </>
