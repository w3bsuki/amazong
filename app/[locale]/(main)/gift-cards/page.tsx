                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                        <div key={i} className="group cursor-pointer">
                            <div className="aspect-[1.6] bg-linear-to-br from-header-bg to-header-nav-bg rounded-lg mb-2 relative overflow-hidden group-hover:opacity-90 transition-opacity">
