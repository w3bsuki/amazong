...
export default async function CategoryPage({
  ...
  products = await searchProducts(supabase, categoryIds, {
        ...
        <div className="flex-1 py-4 sm:py-6">
          ...
          {products.length > 0 && (
            <div className="mt-8 flex justify-center">
              <div className="flex items-center gap-0.5 sm:gap-1 border border-border rounded-lg overflow-hidden">
                <button className="px-3 sm:px-4 py-2 text-sm font-medium text-foreground hover:bg-muted border-r border-border disabled:opacity-50 min-h-10">Previous</button>
                ...
                <button className="px-3 sm:px-4 py-2 text-sm font-medium text-foreground hover:bg-muted min-h-10">Next</button>
              </div>
            </div>
          )}
        </div>
