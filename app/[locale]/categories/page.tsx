  ...
  return (
    <div className="min-h-screen bg-background pb-20 sm:pb-12">
        ...
        <div className="container">
          ...
          <div className="flex items-center gap-3 mb-2">
            <div className="size-12 sm:size-14 bg-white/10 rounded-full flex items-center justify-center">
              <GridFour className="size-6 sm:size-7 text-white" />
            </div>
            <div>
      ...
      <div className="container -mt-4 sm:-mt-6">
        {/* Category List - Browse by Department (Main Section) */}
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {categories.map((category) => {
              const categoryName = locale === "bg" && category.name_bg ? category.name_bg : category.name
