...
import { ProductPageDesktopV2 } from "@/components/shared/product/product-page-desktop-v2"
...
export default async function PreviewProductHybrid({ params }: PreviewProductPageProps) {
  ...
  const sampleProduct = {
    ...
    attributes: {
      ...
      condition: "new",
      gender: "Men",
      "condition-detail": "new-with-tags"
    }
  }
  ...
  return (
    <div className="min-h-screen bg-background pb-24 lg:pb-10">
      <div className="border-b bg-cta-trust-blue/10 text-cta-trust-blue">
        <div className="container py-2 text-sm font-medium">
          ✨ Preview: HYBRID product page (your gallery + product-detail6 mobile patterns)
      ...
      <div className="container pt-4">
        <ProductPageDesktopV2
          product={{
            ...
            attributes: (resolvedProduct.attributes as Record<string, any>) || {},
          }}
          seller={
            seller
              ? {
