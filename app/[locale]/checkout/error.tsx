...
import { WarningCircle, ShoppingCart, ArrowCounterClockwise } from '@phosphor-icons/react'
    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-muted-foreground mb-6">
          We couldn&apos;t process your checkout. Your cart items are safe. Please try again.
        </p>
