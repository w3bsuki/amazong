      ...
      <div className="min-h-[60vh] flex items-center justify-center p-4">
        <Card className="max-w-md w-full border-0 shadow-lg">
          <CardContent className="p-8 text-center">
            ...
            <Button asChild size="lg" className="bg-brand hover:bg-brand/90 text-white rounded-full">
              <Link href="/">
                {t("continueShopping")}
              </Link>
            </Button>
    ...
    <div className="min-h-screen pb-32 lg:pb-8">
      <div className="container py-4 lg:py-6 max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          {/* Main Content - Continuous flow on mobile, sections on desktop */}
          <div className="lg:col-span-2">
            {/* Desktop: Single Card wrapper with outlined inner sections */}
            ...
            {/* Mobile: Flat continuous layout with no cards */}
            <div className="lg:hidden space-y-6">
              ...
              {/* Mobile Order Summary (inline, not sticky) */}
              <section className="pb-4">
                <h2 className="font-semibold mb-3">{t("orderSummary")}</h2>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">{t("subtotal")} ({totalItems})</span>
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="zip" className="text-xs">{t("zipCode")}</Label>
            <Input 
              id="zip"
              placeholder="10001"
    ...
    return (
      <RadioGroup value={shippingMethod} onValueChange={setShippingMethod} className="space-y-2">
        ...
        >
          ...
          <Badge variant="secondary" className="bg-brand-success/10 text-brand-success border-0 font-semibold">
            {t("free")}
          </Badge>
        </label>
        ...
        {items.slice(0, 3).map((item) => (
          <div key={item.id} className="flex gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">{t("qty")}: {item.quantity}</p>
            </div>
