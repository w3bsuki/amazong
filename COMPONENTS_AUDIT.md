...
Generated: 2026-02-10T21:54:53.324Z

## Snapshot

- Total directories in `components/`: 35
- Total files in `components/`: 137
- Code files in `components/`: 137
- Used files: 137
- Unused files: 0
...
| 268 | `components/shared/product/quick-view/product-quick-view-mobile-content.tsx` | `components/shared/product/quick-view/product-quick-view-content.tsx` |
| 256 | `components/shared/product/quick-view/product-quick-view-desktop-content.tsx` | `components/shared/product/quick-view/product-quick-view-content.tsx` |
| 239 | `components/mobile/drawers/messages-drawer.tsx` | `components/mobile/drawers/index.ts` |
| 233 | `components/mobile/drawers/auth-drawer.tsx` | `components/mobile/drawers/index.ts` |
...
| 160 | `components/mobile/drawers/product-quick-view-drawer.tsx` | `components/mobile/drawers/index.ts` |
...
| 65 | `components/layout/header/mobile/homepage-header.tsx` | `components/layout/header/mobile/index.ts` |
...
### 3) Deterministic Move Candidates

Rule set: importer scope must be one route group or one route-private tree; `components/ui/*` is excluded.
Machine-readable output: `cleanup/components-move-candidates.json`

| Priority | File | Reason | Scope | Refs | Suggested target |
| ---: | --- | --- | --- | ---: | --- |
| 3 | `components/mobile/category-nav/index.ts` | All importers are confined to one route group | `app/[locale]/(main)` | 4 | `app/[locale]/(main)/_components/index.ts` |
| 3 | `components/grid/index.ts` | All importers are confined to one route group | `app/[locale]/(main)` | 4 | `app/[locale]/(main)/_components/index.ts` |

## Full Component Map

| Path | Type | Status | Inbound Refs | Importers (sample) | Notes |
| --- | --- | --- | ---: | --- | --- |
| `components` | dir | used | - | - | 137 used / 0 unused files |
| `components/auth` | dir | used | - | - | 3 used / 0 unused files |
| `components/auth/login-form-body.tsx` | file | used | 3 | `__tests__/auth-login-form-body.test.tsx, app/[locale]/(auth)/_components/login-form.tsx, components/mobile/drawers/auth-drawer.tsx` | loc=274 |
| `components/auth/sign-up-form-body.tsx` | file | used | 2 | `app/[locale]/(auth)/_components/sign-up-form.tsx, components/mobile/drawers/auth-drawer.tsx` | loc=418 |
...
| `components/layout/header/mobile/homepage-header.tsx` | file | used | 1 | `components/layout/header/mobile/index.ts` | loc=65 |
...
| `components/mobile/drawers/auth-drawer.tsx` | file | used | 1 | `components/mobile/drawers/index.ts` | loc=233 |
...
| `components/mobile/drawers/product-quick-view-drawer.tsx` | file | used | 1 | `components/mobile/drawers/index.ts` | loc=160 |
...
| `components/providers/auth-state-manager.tsx` | file | used | 11 | `app/[locale]/_components/app-header.tsx, app/[locale]/_components/guest-sell-cta.tsx, app/[locale]/_components/mobile-tab-bar.tsx` | loc=238 |
...
| `components/shared` | dir | used | - | - | 52 used / 0 unused files |
...
| `components/shared/product` | dir | used | - | - | 21 used / 0 unused files |
| `components/shared/product/_lib` | dir | used | - | - | 2 used / 0 unused files |
| `components/shared/product/_lib/condition-badges.ts` | file | used | 6 | `app/[locale]/[username]/[productSlug]/_components/mobile/mobile-gallery.tsx, app/[locale]/[username]/[productSlug]/_components/pdp/product-header.tsx, app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` | loc=35 |
| `components/shared/product/_lib/condition.ts` | file | used | 5 | `app/[locale]/[username]/[productSlug]/_components/pdp/product-header.tsx, app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx, components/shared/product/card/desktop.tsx` | loc=39 |
...
| `components/shared/product/card/mobile.tsx` | file | used | 6 | `__tests__/product-card-mobile.test.tsx, app/[locale]/(main)/_components/mobile-home.tsx, app/[locale]/(main)/_components/mobile/promoted-listings-strip.tsx` | loc=277 |
| `components/shared/product/card/price.tsx` | file | used | 4 | `__tests__/product-card-price.test.tsx, components/shared/product/card/desktop.tsx, components/shared/product/card/list.tsx` | loc=229 |
...
| `components/shared/product/quick-view` | dir | used | - | - | 6 used / 0 unused files |
| `components/shared/product/quick-view/product-quick-view-content.tsx` | file | used | 4 | `app/[locale]/_components/drawers/product-quick-view-dialog.tsx, components/mobile/drawers/product-quick-view-drawer.tsx, components/shared/product/quick-view/product-quick-view-desktop-content.tsx` | loc=201 |
| `components/shared/product/quick-view/product-quick-view-desktop-content.tsx` | file | used | 1 | `components/shared/product/quick-view/product-quick-view-content.tsx` | loc=256 |
| `components/shared/product/quick-view/product-quick-view-mobile-content.tsx` | file | used | 1 | `components/shared/product/quick-view/product-quick-view-content.tsx` | loc=268 |
| `components/shared/product/quick-view/quick-view-image-gallery.tsx` | file | used | 2 | `components/shared/product/quick-view/product-quick-view-desktop-content.tsx, components/shared/product/quick-view/product-quick-view-mobile-content.tsx` | loc=244 |
| `components/shared/product/quick-view/quick-view-seller-card.tsx` | file | used | 2 | `components/shared/product/quick-view/product-quick-view-desktop-content.tsx, components/shared/product/quick-view/product-quick-view-mobile-content.tsx` | loc=92 |
...
| `components/ui/badge.tsx` | file | used | 79 | `app/[locale]/_components/seller/boost-dialog.tsx, app/[locale]/(account)/account/_components/account-addresses-grid.tsx, app/[locale]/(account)/account/_components/account-addresses-stats.tsx` | loc=111 |
| `components/ui/breadcrumb.tsx` | file | used | 1 | `app/[locale]/_components/navigation/app-breadcrumb.tsx` | loc=112 |
| `components/ui/button.tsx` | file | used | 157 | `app/[locale]/_components/auth/auth-gate-card.tsx, app/[locale]/_components/cookie-consent.tsx, app/[locale]/_components/empty-state-cta.tsx` | loc=82 |
| `components/ui/card.tsx` | file | used | 109 | `app/[locale]/_components/auth/auth-gate-card.tsx, app/[locale]/_components/charts/chart-area-interactive.tsx, app/[locale]/_components/guest-sell-cta.tsx` | loc=91 |
...
| `components/ui/drawer.tsx` | file | used | 18 | `app/[locale]/_components/category-browse-drawer.tsx, app/[locale]/(main)/_components/mobile/home-city-picker-sheet.tsx, app/[locale]/(sell)/_components/fields/condition-field.tsx` | loc=342 |
...
| `components/ui/icon-button.tsx` | file | used | 19 | `app/[locale]/_components/category-browse-drawer.tsx, app/[locale]/(main)/cart/_components/cart-page-client.tsx, app/[locale]/[username]/[productSlug]/_components/desktop/desktop-buy-box.tsx` | loc=39 |
| `components/ui/input.tsx` | file | used | 51 | `app/[locale]/_components/address-form.tsx, app/[locale]/_components/category-browse-drawer.tsx, app/[locale]/_components/search/mobile-search-overlay.tsx` | loc=23 |
...
| `components/ui/skeleton.tsx` | file | used | 75 | `app/[locale]/_components/category-browse-drawer.tsx, app/[locale]/(account)/account/_components/account-page-header-skeleton.tsx, app/[locale]/(account)/account/addresses/loading.tsx` | loc=14 |
...
- [ ] Batch A (route-private tree moves): 0 candidates from deterministic rules.
- [ ] Batch B (route-group confined moves): 2 candidates from deterministic rules.
- [ ] Batch C (barrel/index cleanup after moves): 2 candidate index files.
...
- Deterministic move candidates are suggestions; resolve naming collisions before applying.
