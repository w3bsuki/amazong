...
Generated: 2026-02-09T10:54:33.417Z

## Snapshot

- Total directories in `components/`: 49
- Total files in `components/`: 193
- Code files in `components/`: 193
- Used files: 193
- Unused files: 0
...
| ---: | --- | --- |
| 484 | `components/desktop/product/desktop-buy-box.tsx` | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` |
| 443 | `components/desktop/desktop-search.tsx` | `components/layout/header/desktop/standard-header.tsx` |
| 431 | `components/mobile/drawers/seller-profile-drawer.tsx` | `components/mobile/product/mobile-product-single-scroll.tsx` |
| 420 | `components/support/support-chat-widget.tsx` | `components/support/customer-service-chat.tsx` |
| 415 | `components/mobile/drawers/account-drawer.tsx` | `components/mobile/drawers/index.ts` |
| 337 | `components/mobile/product/mobile-product-single-scroll.tsx` | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` |
| 316 | `components/shared/product/card/list.tsx` | `components/grid/product-grid.tsx` |
| 308 | `components/mobile/product/mobile-gallery.tsx` | `components/mobile/product/mobile-product-single-scroll.tsx` |
...
| 217 | `components/mobile/product/mobile-bottom-bar.tsx` | `components/mobile/product/mobile-product-single-scroll.tsx` |
...
| 201 | `components/desktop/product/desktop-specs-accordion.tsx` | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` |
...
| 165 | `components/desktop/product/desktop-gallery.tsx` | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` |
...
| 148 | `components/shared/product/product-feed.tsx` | `app/[locale]/(main)/categories/[slug]/_components/mobile/mobile-category-browser-contextual.tsx` |
...
| 130 | `components/mobile/product/mobile-seller-preview-card.tsx` | `components/mobile/product/mobile-product-single-scroll.tsx` |
...
| 114 | `components/desktop/product/product-quick-view-dialog.tsx` | `app/[locale]/_components/global-drawers.tsx` |
...
| 89 | `components/layout/header/minimal-header.tsx` | `app/[locale]/(plans)/_components/plans-page-client.tsx` |
| 78 | `components/providers/sonner.tsx` | `app/[locale]/_components/storefront-shell.tsx` |

### 2) App-Only Components Under Global `components/`

| Refs | LOC | File |
| ---: | ---: | --- |
| 2 | 485 | `components/shared/search/overlay/mobile-search-overlay.tsx` |
| 1 | 484 | `components/desktop/product/desktop-buy-box.tsx` |
| 3 | 387 | `components/shared/seller/boost-dialog.tsx` |
| 1 | 337 | `components/mobile/product/mobile-product-single-scroll.tsx` |
| 3 | 294 | `components/shared/charts/chart-area-interactive.tsx` |
| 1 | 201 | `components/desktop/product/desktop-specs-accordion.tsx` |
| 2 | 192 | `components/ui/command.tsx` |
| 2 | 182 | `components/mobile/filters/mobile-filter-controls.tsx` |
| 1 | 165 | `components/desktop/product/desktop-gallery.tsx` |
| 2 | 157 | `components/category/subcategory-tabs.tsx` |
| 2 | 154 | `components/shared/star-rating-dialog.tsx` |
| 1 | 148 | `components/shared/product/product-feed.tsx` |
...
| 1 | 114 | `components/desktop/product/product-quick-view-dialog.tsx` |
| 2 | 106 | `components/layout/nav-user.tsx` |
| 14 | 97 | `components/ui/table.tsx` |
| 1 | 89 | `components/layout/header/minimal-header.tsx` |
| 1 | 78 | `components/providers/sonner.tsx` |
| 1 | 73 | `components/shared/product/pdp/seller-products-grid.tsx` |
| 1 | 71 | `components/shared/product/pdp/product-social-proof.tsx` |
| 10 | 69 | `components/ui/accordion.tsx` |
| 1 | 67 | `components/layout/nav-main.tsx` |
| 2 | 67 | `components/ui/alert.tsx` |
| 2 | 66 | `components/shared/orders/order-status-badge.tsx` |
| 1 | 50 | `components/shared/product/pdp/trust-badges.tsx` |
| 2 | 49 | `components/shared/page-container.tsx` |
| 1 | 48 | `components/shared/product/product-grid-skeleton.tsx` |
...
| --- | --- | --- | ---: | --- | --- |
| `components` | dir | used | - | - | 193 used / 0 unused files |
...
| `components/category` | dir | used | - | - | 2 used / 0 unused files |
| `components/category/subcategory-circles.tsx` | file | used | 2 | `app/[locale]/(main)/_components/desktop-home.tsx, components/category/subcategory-tabs.tsx` | loc=287 |
| `components/category/subcategory-tabs.tsx` | file | used | 2 | `app/[locale]/(main)/categories/[slug]/page.tsx, app/[locale]/(main)/search/page.tsx` | loc=157 |
| `components/desktop` | dir | used | - | - | 9 used / 0 unused files |
| `components/desktop/category-attribute-dropdowns.tsx` | file | used | 1 | `components/desktop/feed-toolbar.tsx` | loc=186 |
| `components/desktop/desktop-search.tsx` | file | used | 1 | `components/layout/header/desktop/standard-header.tsx` | loc=443 |
...
| `components/desktop/product` | dir | used | - | - | 4 used / 0 unused files |
| `components/desktop/product/desktop-buy-box.tsx` | file | used | 1 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` | loc=484 |
| `components/desktop/product/desktop-gallery.tsx` | file | used | 1 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` | loc=165 |
| `components/desktop/product/desktop-specs-accordion.tsx` | file | used | 1 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` | loc=201 |
| `components/desktop/product/product-quick-view-dialog.tsx` | file | used | 1 | `app/[locale]/_components/global-drawers.tsx` | loc=114 |
...
| `components/grid/index.ts` | file | used | 4 | `app/[locale]/(main)/_components/desktop-home.tsx, app/[locale]/(main)/categories/[slug]/page.tsx, app/[locale]/(main)/search/page.tsx` | loc=10 |
| `components/grid/product-grid.tsx` | file | used | 2 | `__tests__/product-grid-preset.test.tsx, components/grid/index.ts` | loc=231 |
| `components/layout` | dir | used | - | - | 19 used / 0 unused files |
| `components/layout/footer` | dir | unused | - | - | 0 used / 0 unused files |
| `components/layout/header` | dir | used | - | - | 14 used / 0 unused files |
...
| `components/layout/header/dashboard-header.tsx` | file | used | 1 | `app/[locale]/(admin)/admin/layout.tsx` | loc=32 |
| `components/layout/header/desktop` | dir | used | - | - | 3 used / 0 unused files |
...
| `components/layout/header/minimal-header.tsx` | file | used | 1 | `app/[locale]/(plans)/_components/plans-page-client.tsx` | loc=89 |
...
| `components/layout/nav-main.tsx` | file | used | 1 | `app/[locale]/(admin)/_components/admin-sidebar.tsx` | loc=67 |
| `components/layout/nav-secondary.tsx` | file | used | 1 | `app/[locale]/(admin)/_components/admin-sidebar.tsx` | loc=41 |
| `components/layout/nav-user.tsx` | file | used | 2 | `app/[locale]/(admin)/_components/admin-sidebar.tsx, app/[locale]/(business)/_components/business-sidebar.tsx` | loc=106 |
...
| `components/layout/sidebar/sidebar.tsx` | file | used | 12 | `app/[locale]/(account)/account-layout-content.tsx, app/[locale]/(account)/account/_components/account-header.tsx, app/[locale]/(account)/account/_components/account-sidebar.tsx` | loc=750 |
| `components/mobile` | dir | used | - | - | 17 used / 0 unused files |
...
| `components/mobile/category-nav/filter-sort-bar.tsx` | file | used | 2 | `components/mobile/category-nav/index.ts, components/mobile/filters/mobile-filter-controls.tsx` | loc=195 |
...
| `components/mobile/drawers` | dir | used | - | - | 7 used / 0 unused files |
...
| `components/mobile/drawers/seller-profile-drawer.tsx` | file | used | 1 | `components/mobile/product/mobile-product-single-scroll.tsx` | loc=431 |
| `components/mobile/filters` | dir | used | - | - | 1 used / 0 unused files |
| `components/mobile/filters/mobile-filter-controls.tsx` | file | used | 2 | `app/[locale]/(main)/categories/[slug]/_components/mobile/mobile-category-browser-contextual.tsx, app/[locale]/(main)/search/page.tsx` | loc=182 |
| `components/mobile/product` | dir | used | - | - | 5 used / 0 unused files |
| `components/mobile/product/mobile-bottom-bar.tsx` | file | used | 1 | `components/mobile/product/mobile-product-single-scroll.tsx` | loc=217 |
| `components/mobile/product/mobile-gallery.tsx` | file | used | 1 | `components/mobile/product/mobile-product-single-scroll.tsx` | loc=308 |
| `components/mobile/product/mobile-product-single-scroll.tsx` | file | used | 1 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` | loc=337 |
| `components/mobile/product/mobile-seller-preview-card.tsx` | file | used | 1 | `components/mobile/product/mobile-product-single-scroll.tsx` | loc=130 |
| `components/mobile/product/mobile-trust-sections.tsx` | file | used | 1 | `components/mobile/product/mobile-product-single-scroll.tsx` | loc=68 |
| `components/providers` | dir | used | - | - | 13 used / 0 unused files |
...
| `components/providers/cart-context.tsx` | file | used | 17 | `app/[locale]/_providers/commerce-providers.tsx, app/[locale]/(account)/account/wishlist/_components/account-wishlist-grid.tsx, app/[locale]/(checkout)/_actions/checkout.ts` | loc=491 |
...
| `components/providers/drawer-context.tsx` | file | used | 12 | `app/[locale]/_components/global-drawers.tsx, app/[locale]/_components/mobile-tab-bar.tsx, app/[locale]/_providers/commerce-providers.tsx` | loc=344 |
...
| `components/providers/sonner.tsx` | file | used | 1 | `app/[locale]/_components/storefront-shell.tsx` | loc=78 |
| `components/providers/theme-provider.tsx` | file | used | 1 | `app/[locale]/locale-providers.tsx` | loc=12 |
| `components/providers/wishlist-context.tsx` | file | used | 11 | `app/[locale]/_providers/commerce-providers.tsx, app/[locale]/(main)/wishlist/_components/wishlist-page-client.tsx, components/desktop/product/desktop-buy-box.tsx` | loc=338 |
| `components/shared` | dir | used | - | - | 85 used / 0 unused files |
| `components/shared/auth` | dir | used | - | - | 1 used / 0 unused files |
| `components/shared/auth/auth-gate-card.tsx` | file | used | 4 | `app/[locale]/(chat)/chat/[conversationId]/page.tsx, app/[locale]/(chat)/chat/page.tsx, app/[locale]/(sell)/_components/sign-in-prompt.tsx` | loc=70 |
| `components/shared/category` | dir | used | - | - | 3 used / 0 unused files |
| `components/shared/category/category-circle-visual.tsx` | file | used | 4 | `app/[locale]/(main)/categories/page.tsx, components/category/subcategory-circles.tsx, components/category/subcategory-tabs.tsx` | loc=114 |
...
| `components/shared/charts` | dir | used | - | - | 2 used / 0 unused files |
| `components/shared/charts/chart-area-interactive.tsx` | file | used | 3 | `app/[locale]/(admin)/admin/page.tsx, app/[locale]/(business)/dashboard/analytics/page.tsx, app/[locale]/(business)/dashboard/page.tsx` | loc=294 |
| `components/shared/charts/chart.tsx` | file | used | 3 | `app/[locale]/(account)/account/_components/account-chart.tsx, app/[locale]/(account)/account/sales/_components/sales-chart.tsx, components/shared/charts/chart-area-interactive.tsx` | loc=344 |
...
| `components/shared/design-system` | dir | unused | - | - | 0 used / 0 unused files |
| `components/shared/dropdown-product-item.tsx` | file | used | 1 | `components/dropdowns/wishlist-dropdown.tsx` | loc=75 |
| `components/shared/empty-state-cta.tsx` | file | used | 5 | `app/[locale]/(main)/_components/desktop-home.tsx, app/[locale]/(main)/categories/[slug]/page.tsx, app/[locale]/(main)/search/page.tsx` | loc=165 |
...
| `components/shared/field.tsx` | file | used | 20 | `app/[locale]/(account)/account/profile/profile-content.tsx, app/[locale]/(auth)/_components/forgot-password-form.tsx, app/[locale]/(auth)/auth/reset-password/reset-password-client.tsx` | loc=149 |
| `components/shared/filters` | dir | used | - | - | 15 used / 0 unused files |
| `components/shared/filters/_lib` | dir | unused | - | - | 0 used / 0 unused files |
...
| `components/shared/filters/filter-chips.tsx` | file | used | 3 | `app/[locale]/(main)/categories/[slug]/page.tsx, app/[locale]/(main)/search/page.tsx, components/mobile/filters/mobile-filter-controls.tsx` | loc=309 |
| `components/shared/filters/filter-hub.tsx` | file | used | 2 | `components/mobile/filters/mobile-filter-controls.tsx, components/shared/filters/sections/filter-category-section.tsx` | loc=640 |
...
| `components/shared/locale-switcher.tsx` | file | used | 1 | `components/layout/header/dashboard-header.tsx` | loc=57 |
...
| `components/shared/product` | dir | used | - | - | 37 used / 0 unused files |
| `components/shared/product/_lib` | dir | used | - | - | 2 used / 0 unused files |
| `components/shared/product/_lib/condition-badges.ts` | file | used | 5 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx, components/mobile/product/mobile-gallery.tsx, components/shared/product/card/list.tsx` | loc=35 |
| `components/shared/product/_lib/condition.ts` | file | used | 4 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx, components/shared/product/card/desktop.tsx, components/shared/product/card/list.tsx` | loc=39 |
...
| `components/shared/product/pdp` | dir | used | - | - | 17 used / 0 unused files |
...
| `components/shared/product/pdp/customer-reviews-hybrid.tsx` | file | used | 2 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx, components/mobile/product/mobile-product-single-scroll.tsx` | loc=200 |
| `components/shared/product/pdp/delivery-options.tsx` | file | used | 1 | `components/mobile/product/mobile-product-single-scroll.tsx` | loc=45 |
| `components/shared/product/pdp/hero-specs.tsx` | file | used | 2 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx, components/mobile/product/mobile-product-single-scroll.tsx` | loc=96 |
| `components/shared/product/pdp/meta-row.tsx` | file | used | 2 | `components/mobile/product/mobile-product-single-scroll.tsx, components/shared/product/pdp/similar-items-grid.tsx` | loc=94 |
| `components/shared/product/pdp/product-description.tsx` | file | used | 1 | `components/mobile/product/mobile-product-single-scroll.tsx` | loc=27 |
| `components/shared/product/pdp/product-header-sync.tsx` | file | used | 1 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` | loc=45 |
| `components/shared/product/pdp/product-header.tsx` | file | used | 1 | `components/mobile/product/mobile-product-single-scroll.tsx` | loc=77 |
| `components/shared/product/pdp/product-social-proof.tsx` | file | used | 1 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` | loc=71 |
| `components/shared/product/pdp/recently-viewed-tracker.tsx` | file | used | 2 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx, components/mobile/product/mobile-product-single-scroll.tsx` | loc=36 |
| `components/shared/product/pdp/seller-products-grid.tsx` | file | used | 1 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` | loc=73 |
| `components/shared/product/pdp/shipping-returns-info.tsx` | file | used | 1 | `components/mobile/product/mobile-product-single-scroll.tsx` | loc=54 |
| `components/shared/product/pdp/similar-items-grid.tsx` | file | used | 1 | `components/mobile/product/mobile-product-single-scroll.tsx` | loc=73 |
| `components/shared/product/pdp/specifications-list.tsx` | file | used | 1 | `components/mobile/product/mobile-product-single-scroll.tsx` | loc=60 |
| `components/shared/product/pdp/trust-badges.tsx` | file | used | 1 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` | loc=50 |
| `components/shared/product/pdp/view-tracker.tsx` | file | used | 1 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx` | loc=33 |
| `components/shared/product/pdp/write-review-dialog.tsx` | file | used | 3 | `app/[locale]/[username]/[productSlug]/_components/product-page-layout.tsx, components/mobile/product/mobile-product-single-scroll.tsx, components/shared/product/pdp/customer-reviews-hybrid.tsx` | loc=210 |
| `components/shared/product/product-feed.tsx` | file | used | 1 | `app/[locale]/(main)/categories/[slug]/_components/mobile/mobile-category-browser-contextual.tsx` | loc=148 |
| `components/shared/product/product-grid-skeleton.tsx` | file | used | 1 | `app/[locale]/(main)/_components/desktop-home.tsx` | loc=48 |
...
| `components/shared/product/quick-view/product-quick-view-content.tsx` | file | used | 2 | `components/desktop/product/product-quick-view-dialog.tsx, components/mobile/drawers/product-quick-view-drawer.tsx` | loc=336 |
...
| `components/shared/product/quick-view/quick-view-skeleton.tsx` | file | used | 2 | `components/desktop/product/product-quick-view-dialog.tsx, components/mobile/drawers/product-quick-view-drawer.tsx` | loc=60 |
...
| `components/shared/search` | dir | used | - | - | 3 used / 0 unused files |
| `components/shared/search/ai` | dir | used | - | - | 1 used / 0 unused files |
| `components/shared/search/ai/search-ai-chat.tsx` | file | used | 2 | `components/desktop/desktop-search.tsx, components/shared/search/overlay/mobile-search-overlay.tsx` | loc=318 |
| `components/shared/search/controls` | dir | unused | - | - | 0 used / 0 unused files |
| `components/shared/search/overlay` | dir | used | - | - | 2 used / 0 unused files |
| `components/shared/search/overlay/mobile-search-overlay.tsx` | file | used | 2 | `app/[locale]/_components/app-header.tsx, app/[locale]/(main)/_components/mobile-home.tsx` | loc=485 |
| `components/shared/search/overlay/search-context.ts` | file | used | 2 | `components/layout/header/mobile/contextual-header.tsx, components/shared/search/overlay/mobile-search-overlay.tsx` | loc=32 |
| `components/shared/seller` | dir | used | - | - | 1 used / 0 unused files |
| `components/shared/seller/boost-dialog.tsx` | file | used | 3 | `app/[locale]/(account)/account/selling/edit/edit-product-client.tsx, app/[locale]/(account)/account/selling/selling-products-list.tsx, app/[locale]/(sell)/_components/sell-form-unified.tsx` | loc=387 |
| `components/shared/spinner.tsx` | file | used | 1 | `components/support/support-chat-widget.tsx` | loc=22 |
| `components/shared/star-rating-dialog.tsx` | file | used | 2 | `app/[locale]/(account)/account/orders/_components/buyer-order-actions.tsx, app/[locale]/(sell)/sell/orders/_components/seller-rate-buyer-actions.tsx` | loc=154 |
| `components/shared/user-avatar.tsx` | file | used | 20 | `app/[locale]/(account)/account/_components/account-sidebar.tsx, app/[locale]/(account)/account/following/following-content.tsx, app/[locale]/(account)/account/profile/profile-content.tsx` | loc=99 |
...
| `components/support` | dir | used | - | - | 2 used / 0 unused files |
| `components/support/customer-service-chat.tsx` | file | used | 1 | `app/[locale]/(main)/(support)/customer-service/page.tsx` | loc=32 |
| `components/support/support-chat-widget.tsx` | file | used | 1 | `components/support/customer-service-chat.tsx` | loc=420 |
...
| `components/ui/badge.tsx` | file | used | 78 | `app/[locale]/(account)/account/_components/account-addresses-grid.tsx, app/[locale]/(account)/account/_components/account-addresses-stats.tsx, app/[locale]/(account)/account/_components/account-badges.tsx` | loc=111 |
...
| `components/ui/card.tsx` | file | used | 108 | `app/[locale]/_components/guest-sell-cta.tsx, app/[locale]/(account)/account/_components/account-addresses-grid.tsx, app/[locale]/(account)/account/_components/account-addresses-stats.tsx` | loc=91 |
...
| `components/ui/dialog.tsx` | file | used | 23 | `app/[locale]/(account)/account/_components/plans-modal.tsx, app/[locale]/(account)/account/addresses/addresses-content.tsx, app/[locale]/(account)/account/orders/_components/buyer-order-actions.tsx` | loc=212 |
...
| `components/ui/dropdown-menu.tsx` | file | used | 15 | `app/[locale]/(account)/account/_components/account-sidebar.tsx, app/[locale]/(account)/account/wishlist/_components/account-wishlist-toolbar.tsx, app/[locale]/(business)/_components/business-notifications.tsx` | loc=187 |
...
| `components/ui/icon-button.tsx` | file | used | 18 | `app/[locale]/_components/category-browse-drawer.tsx, app/[locale]/(main)/cart/_components/cart-page-client.tsx, app/[locale]/[username]/profile-client.tsx` | loc=39 |
| `components/ui/input.tsx` | file | used | 50 | `app/[locale]/_components/address-form.tsx, app/[locale]/_components/category-browse-drawer.tsx, app/[locale]/(account)/account/addresses/addresses-content.tsx` | loc=23 |
| `components/ui/label.tsx` | file | used | 23 | `app/[locale]/_components/address-form.tsx, app/[locale]/(account)/account/addresses/addresses-content.tsx, app/[locale]/(account)/account/orders/_components/buyer-order-actions.tsx` | loc=25 |
| `components/ui/pagination.tsx` | file | used | 1 | `app/[locale]/(main)/_components/search-controls/search-pagination.tsx` | loc=140 |
| `components/ui/popover.tsx` | file | used | 3 | `app/[locale]/(business)/_components/business-notifications.tsx, app/[locale]/(sell)/_components/ui/brand-combobox.tsx, components/desktop/desktop-search.tsx` | loc=49 |
...
| `components/ui/select.tsx` | file | used | 19 | `app/[locale]/_components/geo-welcome-modal.tsx, app/[locale]/(account)/account/_components/account-chart.tsx, app/[locale]/(account)/account/addresses/addresses-content.tsx` | loc=185 |
...
| `components/ui/switch.tsx` | file | used | 11 | `app/[locale]/(account)/account/(settings)/notifications/notifications-content.tsx, app/[locale]/(account)/account/selling/edit/edit-product-client.tsx, app/[locale]/(business)/_components/product-form-modal.tsx` | loc=32 |
...
| `components/ui/textarea.tsx` | file | used | 16 | `app/[locale]/(account)/account/orders/_components/buyer-order-actions.tsx, app/[locale]/(account)/account/orders/[id]/_components/order-detail-content.tsx, app/[locale]/(account)/account/profile/public-profile-editor.tsx` | loc=20 |
| `components/ui/toast.tsx` | file | used | 1 | `hooks/use-toast.ts` | loc=66 |
| `components/ui/toggle-group.tsx` | file | used | 5 | `app/[locale]/(account)/account/_components/account-chart.tsx, app/[locale]/(main)/categories/[slug]/_components/desktop-filter-toolbar.tsx, app/[locale]/(main)/members/_components/members-page-client.tsx` | loc=74 |
