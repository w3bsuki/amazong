...
-- ============================================
-- MOVE CBD UNDER HEALTH & WELLNESS
-- CBD and Functional Mushrooms are wellness products
-- ============================================

-- Convert CBD from L0 to L1 under Health
UPDATE categories 
SET parent_id = 'd1cdc34b-dc6d-42fc-bab4-47e3cbd3a673', -- Health & Wellness
    display_order = 20 -- Put at end of Health subcategories
WHERE slug = 'cbd-wellness' AND parent_id IS NULL;

-- Update subheader order (remove CBD from main nav since it's now under Health)
