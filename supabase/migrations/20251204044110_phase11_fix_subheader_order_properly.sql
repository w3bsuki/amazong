...
-- ============================================
-- FIX SUBHEADER - RESTORE PROPER ORDER
-- Main categories users care about should be visible
-- Niche categories go to "More"
-- ============================================

-- Fix Collectibles name - just "Колекции"
UPDATE categories 
SET name = 'Collectibles',
    name_bg = 'Колекции'
WHERE slug = 'collectibles' AND parent_id IS NULL;

-- REORDER: Put important shopping categories first, niche ones later
-- The subheader shows first 14 categories

-- Main shopping categories (positions 1-14 = visible in subheader)
...
UPDATE categories SET display_order = 9 WHERE slug = 'gaming' AND parent_id IS NULL;
UPDATE categories SET display_order = 10 WHERE slug = 'pets' AND parent_id IS NULL;
UPDATE categories SET display_order = 11 WHERE slug = 'grocery' AND parent_id IS NULL;
UPDATE categories SET display_order = 12 WHERE slug = 'jewelry-watches' AND parent_id IS NULL;
UPDATE categories SET display_order = 13 WHERE slug = 'real-estate' AND parent_id IS NULL;
UPDATE categories SET display_order = 14 WHERE slug = 'tools-home' AND parent_id IS NULL;

-- Secondary/niche categories (positions 15+ = under "More")
UPDATE categories SET display_order = 15 WHERE slug = 'hobbies' AND parent_id IS NULL;
UPDATE categories SET display_order = 16 WHERE slug = 'collectibles' AND parent_id IS NULL;
UPDATE categories SET display_order = 17 WHERE slug = 'e-mobility' AND parent_id IS NULL;
UPDATE categories SET display_order = 18 WHERE slug = 'software' AND parent_id IS NULL;
