...
-- Reorder to include Gaming in visible subheader
...
UPDATE categories SET display_order = 8 WHERE slug = 'gaming' AND parent_id IS NULL;  -- Gaming back in!
UPDATE categories SET display_order = 9 WHERE slug = 'pets' AND parent_id IS NULL;
UPDATE categories SET display_order = 10 WHERE slug = 'real-estate' AND parent_id IS NULL;
UPDATE categories SET display_order = 11 WHERE slug = 'software' AND parent_id IS NULL;
UPDATE categories SET display_order = 12 WHERE slug = 'cbd-wellness' AND parent_id IS NULL;
...
-- Rest in More
UPDATE categories SET display_order = 15 WHERE slug = 'automotive' AND parent_id IS NULL;
